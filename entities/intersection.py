class IntersectionConfig:
    def __init__(self):
        ...
        self.car_speed = 1.0 # Adjust this to change the speed of the cars
        self.collision_threshold = 0.3 # Distance threshold for collision detection (ie: number of units that are close enough to be considered a collision)
